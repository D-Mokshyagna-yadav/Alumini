    ...
    const developers: Developer[] = [
        {
            ...
            title: 'Team Lead',
            bio: 'Loves helping beginners get started with web development. Happy to answer questions and walk you through real projects step by step.',
            avatar: 'https://api.dicebear.com/9.x/rings/svg?seed=mokshyagna',
        ...
        },
        {
            ...
            bio: 'Great at explaining code in simple words. Helps beginners with basics, job prep, and figuring out what to learn next.',
            avatar: 'https://api.dicebear.com/9.x/rings/svg?seed=rain',
        ...
        },
        {
            ...
            title: 'Developer',
            bio: 'Writes clean, easy-to-follow code. Perfect if you want to learn from real-world projects and understand how things work.',
            avatar: 'https://api.dicebear.com/9.x/rings/svg?seed=godkiller',
            portfolio: '',
