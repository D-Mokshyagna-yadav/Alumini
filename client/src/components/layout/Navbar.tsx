                        ...
                        {isLandingPage ? (
                            <div className="hidden sm:block leading-tight" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
                                <div className="flex flex-col items-center">
                                    <div className={`text-[11px] font-bold tracking-wide ${isTransparent ? 'text-white' : 'text-red-600'} text-center`}>DVR &amp; Dr. HS</div>
                                    <div className={`text-[12px] font-bold tracking-wide ${isTransparent ? 'text-white' : 'text-blue-600'} text-center`}>MIC College of Technology</div>
                                    <div className={`text-[11px] font-bold tracking-wide ${isTransparent ? 'text-white' : 'text-red-600'} text-center`}>AUTONOMOUS</div>
                                </div>
                            </div>
                        ) : (
